...
const TESTIMONIALS: Testimonial[] = [
  {
    quote:
      'Working with Element UX was the first time a designer pushed back on ' +
      'the brief and explained why. That directness saved us six weeks.',
    name:    'Marcus Webb',
    title:   'VP Product',
  ...
  {
    quote:
      'The research phase alone changed how we think about our customers. ' +
      'The design was almost secondary -- which is exactly the right order.',
    name:    'Priya Lakhani',
  ...
  {
    quote:
      "We've worked with four agencies. This was the first engagement " +
      'where I did not have to explain what "polish" means.',
    name:    'Jonas Richter',
...
function TestimonialCard({ t }: { t: Testimonial }) {
  return (
    <motion.li variants={staggerChild.fadeUp} className="list-none">
      <article
      ...
      >
        ...
        <blockquote
          ...
          style={{ color: 'var(--fg-secondary)', maxWidth: '38ch', lineHeight: 1.75 }}
        >
          {t.quote}
        </blockquote>
        ...
        <footer className="mt-auto flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-label mt-0.5" style={{ color: 'var(--fg-tertiary)' }}>
        ...
        <div className="mb-16 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          ...
          >
            ...
            <h2 className="text-h2" style={{ color: 'var(--fg-primary)' }}>
              The work speaks.
              <br />
              <span style={{ color: 'var(--fg-secondary)' }}>So do the clients.</span>
            </h2>
          </motion.div>
          ...
          >
            Engagements go deep. These are people I have worked with more than once.
          </motion.p>
        </div>
